...
Short answer: plugins add specialized views, tools, and workflows to FeedBack. This directory gives the design team a first-pass catalog layout and gives users a place to discover what each plugin is for.
...
- Category.
- Status: bundled, optional, experimental, external, or planned.
- Platform notes if any.
- Link to the guide page.
- Screenshot slot.

## Tuning and Detection

| Plugin | Purpose | Status | Guide |
|---|---|---|---|
| Tuner | Tune guitar or bass with current-song tuning, presets, custom tunings, and visual meters. | Available | [Tuner](tuner.md) |
| Note Detection | Listen to your instrument and compare played notes against the active arrangement. | Available | [Note Detection](note-detection.md) |
...
| Plugin | Purpose | Status | Guide |
|---|---|---|---|
| Lyrics Sync | Align lyrics to audio. | Available | [Lyrics](lyrics.md) |
| Lyrics Karaoke | Display timed lyrics or vocal pitch information where available. | Available | [Lyrics](lyrics.md) |
...
The directory should work as a visual grid first and as a reference table second. Keep plugin cards compact: users should be able to scan for a tool by task, not by repository name.
